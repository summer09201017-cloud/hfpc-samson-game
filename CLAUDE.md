...
- 友善:參孫 `SAMSON.maxHearts`(目前 5)顆心、受擊無敵閃爍、**前 3 次死亡無縫復活**(見墮落系統)。神學訊息(力量出於神的靈)在標題/勝利/蜂蜜彩蛋帶出。HUD 血條顯示獅子血量**百分比**。
